...
class _$ChatMessageImpl implements _ChatMessage {
  ...
  @override
  String toString() {
    return 'ChatMessage(id: $id, role: $role, content: $content, timestamp: $timestamp, type: $type, failed: $failed)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, role, content, timestamp, type, failed);
...
abstract class _ChatMessage implements ChatMessage {
  const factory _ChatMessage(
      ...
      final ChatMessageType type,
      final bool failed}) = _$ChatMessageImpl;
